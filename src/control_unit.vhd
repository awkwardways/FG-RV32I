...
begin
  ...
  alu_op       <= "100" when opcode = "1100011" and funct_3 = "000" else
                  "001" when opcode = "1100011" and funct_3 = "000" else
  ...
  neg_alu      <= '1' when opcode = "1100011" and funct_3 = "000" else
                  '1' when opcode = "1100011" and funct_3 = "101" else
                  '1' when opcode = "1100011" and funct_3 = "111" else '0';
